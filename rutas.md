# Información de rutas recolectadas #

Para la primera fase, solo en la zona central. Las rutas que comienzan con letra están al final.
...
| 99     | Completa | **Bosa La Primavera** - **Germania** |
...
| 282    | | **Lijacá** |
| 283    | Completa | **Chicó Norte** |
| 291    | Completa | **Lijacá** - **Av. Esperanza** |
| 312    | | **Lijacá** |
...
| 341    | | **La Estrellita** - **Metrovivienda** |
...
Completa indica que se recolectaron todo el trayecto por la zona central. Puede que el resto de la ruta sea desconocido.

# Abreviaturas

Descripción de las abreviaturas usadas
...
* dg: diagonal.
* av: avenida.
* NQS: Norte-Quito-Sur o carrera 30.
* circunvalar: Avenida circunvalar por los cerros.
* calera: carretera vía La Calera
